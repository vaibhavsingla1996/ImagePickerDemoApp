...
extension UIResponder {
    ...
    func pleaseWaitWithImages(_ imageNames: Array<UIImage>, timeInterval: Int) {
        SwiftNotice.wait(imageNames, timeInterval: timeInterval, isFullScreen: false)
    }
    ...
    func pleaseWait(isFullScreen:Bool) {
        SwiftNotice.wait(isFullScreen: isFullScreen)
    }
...
class SwiftNotice: NSObject {
    ...
    static func wait(_ imageNames: Array<UIImage> = Array<UIImage>(), timeInterval: Int = 0, isFullScreen:Bool) {
